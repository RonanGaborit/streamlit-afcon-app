...
from fonctions import assists, passnetwork, passe, pressure_heatmap, shot, pass_cross, passe, defensive_actions, \
    mistake, player
...
plot_options = ['Passing Network', 'Passes', 'Pressure heatmap', 'Shots', 'Forward Passes', 'Crosses',
                'Defensive Actions',
